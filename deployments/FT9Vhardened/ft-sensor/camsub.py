...
mqttc.tls_set_client_cert("certs/sensor.crt", tls_version=mqtt.ssl.PROTOCOL_TLSv1_2)
mqttc.tls_set_key("certs/sensor.key")
mqttc.tls_set("certs/ca.crt")
mqttc.tls_insecure_set(True)
mqttc.tls_set_context(None)
mqttc.username_pw_set("ft-sensor", "ft-sensor")

mqttc.on_connect = on_connect
mqttc.on_message = on_message

mqttc.connect("ft-broker", 8883, 60)
